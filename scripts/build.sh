...
DEST_BIN=terraform-provider-javascript
...
echo ""
echo "Moving terraform-provider-javascript_${XC_OS}_${XC_ARCH} to $DEST_PATH/$DEST_BIN"
echo ""

mv terraform-provider-javascript_${XC_OS}_${XC_ARCH} $DEST_PATH/$DEST_BIN
